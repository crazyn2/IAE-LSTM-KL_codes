...
from models.fmnist import AeV4V1MsdLstmV1
...
def fmnist_lenet(bash_log_name,
    ...
    auto_enc = AeV4V1.load_from_checkpoint(
        load_pre_ae_model(bash_log_name=bash_log_name,
                          ...
                          model_name="aev4v1"))
    mse_loss_weights = [
        1.495501, 7.414525, 0.391224, 2.457582, 2.540750, 0.000284, 0.000284,
        32.369513, 0.583155, 28.481469
    ]
    lnr_svdd = AeV4V1MsdLstmV1(seed=seed,
