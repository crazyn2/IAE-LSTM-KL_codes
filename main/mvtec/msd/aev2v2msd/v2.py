...
from models.mvtec.msd import AeV2V2V1MsdV2
...
def main(bash_log_name,
    ...
    kl_loss_weights = [
        0.004627, 0.022703, 0.082576, 100.788448, 22.299111, 41.37578,
        0.337901, 0.24067, 0.001831, 31.513772, 21.864, 0.064997, 0.01667,
        0.001032, 0.00266
    ]
    mse_loss_weights = [
        0.001641, 0.795601, 0.136953, 998.22267, 10.296907, 5115.531262,
        0.007754, 0.001328, 0.671612, 936.012256, 0.000352, 18.782327, 0.00815,
        89.426457, 0.642246
    ]
    nus = [
    ...
    lnr_svdd = AeV2V2V1MsdV2(seed=seed,
                             nu=nus[normal_class],
