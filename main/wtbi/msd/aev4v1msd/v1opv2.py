...
from models.fmnist import AeV4V1MsdV1
...
def main_lenet(trial,
    ...
    mse_loss_weight = trial.suggest_float("mse_loss_weight",
                                          ...
                                          1e4,
                                          log=True)
    lnr_svdd = AeV4V1MsdV1(mse_loss_weight=mse_loss_weight,
                           nu=nu,
                           seed=seed,
...
if __name__ == '__main__':
    ...
    auto_enc = AeV4V1.load_from_checkpoint(
        load_pre_ae_model(bash_log_name='bash-logv3',
                          ...
                          normal_class=None,
                          model_name="aev4v1"))
    optuna_main(args=args, main=main_lenet, file=__file__)
