...
def lenet_main(trial,
    ...
    kl_loss_weight = trial.suggest_float("kl_loss_weight", 10e-12, 1, log=True)
    mse_loss_weight = trial.suggest_float("mse_loss_weight", 1e-9, 1, log=True)
...
if __name__ == '__main__':
    ...
    auto_enc = AeV4V1.load_from_checkpoint(
        load_pre_ae_modelv2(bash_log_name='bash-logv3',
