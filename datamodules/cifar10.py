...
class CIFAR10Dm(pl.LightningDataModule):
    ...
    def __init__(
        ...
        if normal_class_array is not None:
            self.normal_classes = tuple(normal_class_array)
...
class CIFAR10DmV2(pl.LightningDataModule):
