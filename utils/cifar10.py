...
def init_envir():
    ...
    parser.add_argument('--obj', type=str, default="one-class")
    ...
    parser.add_argument('--mse_pow', type=float, default=1)
    parser.add_argument('--kl_pow', type=float, default=1)
...
def optuna_main(args, main, file=__file__):
    ...
    #     message = (f"{file} Normal class {args.normal_class} " +
    #                value_msg + " process took %02d:%02d:%02d " % (h, m, s) +
    #                sampler_pruner)
    #     push_tg(message)
